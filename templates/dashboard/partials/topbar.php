...
<header class="topbar">
    ...
    <div class="topbar-right">
        ...
        <button id="dev-notes-toggle" class="btn btn-outline btn-sm" aria-label="Notas para el Desarrollador Backend" title="Alternar Notas de Especificación Backend" style="padding: 6px 10px; gap: 6px; font-size: 0.8rem;">
            ...
            <span class="dev-notes-btn-text">Notas Backend</span>
        </button>
